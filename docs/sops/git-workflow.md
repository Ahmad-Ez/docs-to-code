...
### Step 4: Sync Back to Dev (Optional)

> Skip this step if no commits were added to the release branch (i.e. no polish/bug fixes during release prep). If the release branch is identical to `dev`, there is nothing to sync back.
