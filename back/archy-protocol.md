...
5. **Update State**:
   ...
   - Update "Troubleshooting & Lessons Learned" in `base-prompt.md`.
...
8. **Handoff**:
   ...
   - Instruct user: _"Bootstrap complete. Run `execute @.archy/base-prompt.md` to begin building, or `./archy/archy-runner.sh` for full autopilot."_
...
3. Update the "Troubleshooting & Lessons Learned" section in `base-prompt.md` with any new technical insights.
...
5. Terminate. Do not pick up the next task. A fresh session will be started
...
_Docs-to-Code (Archy Protocol) v4.1 — "Mission Control"_
_Designed for full automation with strategic human oversight._
